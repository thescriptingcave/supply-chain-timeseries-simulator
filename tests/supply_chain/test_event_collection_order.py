...
def test_event_collection_exists_before_departure_event_is_emitted() -> None:
    ...
    def warehouse(warehouse_id: int, lat: float, lon: float) -> WarehouseState:
