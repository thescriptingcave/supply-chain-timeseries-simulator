...
Run from repository root:
    ...
    uv run python -m scripts.generate_supply_chain_v3_production --days 30 --seed 42
"""
...
def build_production_categories(
    *,
    ...
    contention_count = min(max(3, round(shipment_count * 0.02)), shipment_count)
    ...
    try:
        ...
        run_id = writer.create_simulation_run(
            SimulationRunRecord(
                ...
                status="STARTED",
                metadata_json={
                    "purpose": "v3-production-scale-validation",
        ...
        print("[Supply Chain v3] Production dataset passed")
