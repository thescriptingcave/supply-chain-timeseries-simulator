"""Persisted deterministic heavy-rain integration gate for Supply Chain v3.

Run from repository root:

    uv run python -m scripts.supply_chain_v3_weather_disruption

This scenario persists one shipment with a route-scoped HEAVY_RAIN disruption
and validates the causal event/ETA/telemetry chain in TimescaleDB.
"""
    ...
    try:
        ...
        run_id = writer.create_simulation_run(
            SimulationRunRecord(
                ...
                status="STARTED",
                metadata_json={
                    "purpose": "heavy-rain-integration-gate",
                    "weather_start_offset_minutes": 30,
                    "weather_duration_minutes": 60,
                    "weather_factor": 0.70,
